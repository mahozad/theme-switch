;(function(){"use strict";const a=24;const b="#000";const c="theme";const d="auto";const e="dark";const f="light";const g=f;const h="data-theme";const i="(prefers-color-scheme: dark)";const j=[10,0,33,0];const k=[10,0,20,1];const l=[5,1,33,1];let m;class n extends HTMLElement{constructor(){super();m=this.attachShadow({mode:"open"});m.innerHTML=o(...t());m.host.addEventListener("click",u);const b=document.createElement("style");b.textContent=p();m.append(b)}}function o(e,a,b,c){return`
    ...
    #circle { fill: var(--theme-switch-icon-color, ${b}); }

    #rays { stroke: var(--theme-switch-icon-color, ${b}); }
    `}q();window.customElements.define("theme-switch",n);window.matchMedia(i).addEventListener("change",q);function q(){let b=r();if(b===d)b=s();document.documentElement.setAttribute(h,b)}function r(){const b=localStorage.getItem(c);return b===null?g:b}function s(){const b=window.matchMedia(i).matches;return b?e:f}function t(){let b=r();if(b===d){return j}else if(b===e){return k}else{return l}}function u(){let b=r();if(b===d){localStorage.setItem(c,f);v()}else if(b===e){localStorage.setItem(c,d);w()}else{localStorage.setItem(c,e);x()}q()}function v(){m.getElementById("letter-anim-hide").beginElement();m.getElementById("core-anim-shrink").beginElement();m.getElementById("rays-anim-rotate").beginElement();m.getElementById("rays-anim-show").beginElement()}function w(){m.getElementById("eclipse-anim-go").beginElement();m.getElementById("letter-anim-show").beginElement()}function x(){m.getElementById("rays-anim-hide").beginElement();m.getElementById("core-anim-enlarge").beginElement();m.getElementById("eclipse-anim-come").beginElement()}})();
